...
.directive('commentDirective', function() {
  return {
    ...
    <div class="section__text mdl-cell mdl-cell--10-col-desktop mdl-cell--6-col-tablet mdl-cell--3-col-phone event-details">
      ...
      <p>{{ user.data.user.message}} Dolore ex deserunt aute fugiat aute nulla ea sunt aliqua nisi cupidatat eu. Duis nulla tempor do aute et eiusmod velit exercitation nostrud quis</p>
    </div>
    `
  };
});
